                ...
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    ...
                    <div class="widget-content widget-content-area br-6">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 d-flex justify-content-between align-items-center">
                            <h4>Posts</h4>
                            <a href="{{route('admin.post.create')}}" class="btn btn-primary" ><i class="fa fa-plus-circle"></i> Add New</a>
                            ...
                            <table id="zero-config" class="table table-hover table-bordered" style="width:100%">
                                ...
                                @foreach($posts as $key => $post)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.post.view',$post->id)}}" class="btn btn-outline-info btn-small"><i class="fa fa-eye"></i></a>
                                            <a href="{{route('admin.post.edit',$post->id)}}" class="btn btn-outline-primary btn-small"><i class="fa fa-edit"></i></a>
